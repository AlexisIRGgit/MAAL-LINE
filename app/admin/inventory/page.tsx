  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#E8E4D9]">Inventario</h1>
          <p className="text-[#666] mt-1">Control de stock en tiempo real</p>
        </div>
        <button className="inline-flex items-center gap-2 px-5 py-3 bg-[#111] border border-[#222] text-[#E8E4D9] font-medium rounded-xl hover:bg-[#1a1a1a] transition-colors">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-[#E8E4D9]">{totalStock}</p>
              <p className="text-sm text-[#666]">Total en Stock</p>
            </div>
          </div>
        </div>
        <div className="p-5 bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-[#E8E4D9]">{lowStockCount}</p>
              <p className="text-sm text-[#666]">Stock Bajo</p>
            </div>
          </div>
        </div>
        <div className="p-5 bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-[#E8E4D9]">{outOfStockCount}</p>
              <p className="text-sm text-[#666]">Sin Stock</p>
            </div>
          </div>
        </div>
        <div className="p-5 bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-[#E8E4D9]">{totalReserved}</p>
              <p className="text-sm text-[#666]">Reservados</p>
            </div>
          </div>
        </div>
      </motion.div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#1a1a1a]">
                <th className="p-4 text-left text-sm font-medium text-[#666]">SKU</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">Producto</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">Variante</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">En Stock</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">Reservado</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">Disponible</th>
                <th className="p-4 text-left text-sm font-medium text-[#666]">En Camino</th>
            ...
            <tbody>
              {filteredInventory.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <td className="p-4">
                      <span className="text-[#E8E4D9] font-mono text-sm">{item.sku}</span>
                    </td>
                    <td className="p-4">
                      <span className="text-[#E8E4D9]">{item.name}</span>
                    </td>
                    <td className="p-4">
                      <span className="px-2 py-1 bg-[#1a1a1a] rounded text-[#888] text-sm">{item.variant}</span>
                    </td>
                    <td className="p-4">
                      <span className={`font-semibold ${isOut ? 'text-red-500' : isLow ? 'text-yellow-500' : 'text-[#E8E4D9]'}`}>
                        {item.stock}
                      </span>
                    </td>
                    <td className="p-4">
                      <span className="text-blue-400">{item.reserved}</span>
                    </td>
                    <td className="p-4">
                      <span className="text-[#E8E4D9] font-medium">{available}</span>
                    </td>
                    <td className="p-4">
                      {item.incoming > 0 ? (
                        <span className="text-green-500">+{item.incoming}</span>
                      ) : (
